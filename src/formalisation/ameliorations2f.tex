...
Il est utile dans le cas ou on n'a pas de point d'interaction entre différents segments successifs.

\begin{mydef}[Point d'interaction]
	Un point d'interaction est un endroit ou l'exécution du réseau de Petri est soumise à influence extérieure : condition, déclenchement interactif, etc. Une définition complète est donnée dans \cite[p. 148]{allombert2009aspects}.
\end{mydef}
