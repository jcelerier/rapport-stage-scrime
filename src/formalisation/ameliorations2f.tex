...
\begin{mydef}[Point d'interactivité]
	Un point d'interactivité (TODO nom à revoir?) est un endroit ou l'exécution du réseau de Petri est soumise à influence extérieure : temps souple, ou condition.
\end{mydef}
