...
Au niveau de ce qui a été présenté précédemment, le changement principal est que les différents arcs de sortie d'une place pourront chacuns être reliés à une $\alpha$-transition différente si nécessaire.
