...
\begin{itemize}
	...
	\item Deux machines virtuelles sous \brand{Debian}, chacune reliée à la machine \brand{WANem}.
\end{itemize}

La machine \brand{WANem} est réglée pour simuler une latence fixe de $\num{50}\si{\milli\second}$ entre les deux machines sous \brand{Debian}, ce qui correspond à des conditions moyennes sur Internet.
...
Sans déplacement, on obtient un retard de $\num{15} \si{\milli\second}$  lors de l'exécution de $t2$. L'exécution est visible en \cref{fig.androSimpl}.
