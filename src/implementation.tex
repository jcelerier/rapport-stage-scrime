...
\begin{itemize}
	...
	\item \texttt{/group/parameter/nomDuParamètre/fonctionnalité} envoi le message correspondant à la fonctionnalité présentée.
\end{itemize}

Il y a deux possibilités pour réaliser cela : 
\begin{itemize}
	\item Approche simple : la machine qui fait tourner la session maître gère les options des groupes, et envoie et reçoit les messages décris précédemment.
...
Pour des raisons de temps, et de simplicité d'implémentation, c'est la première approche qui est retenue.
