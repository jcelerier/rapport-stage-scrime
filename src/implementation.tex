...
Néanmoins, j'ai gardé la possibilité de connexions entre machines en utilisant un couple \verb|IP:port|.
...
\begin{itemize}
	\item \texttt{/group/enable/fonctionnalité}
	\item \texttt{/group/disable/fonctionnalité}
	\item \texttt{/group/parameter/nomDuParamètre id}
\end{itemize}

Émis par le groupe :
\begin{itemize}
	\item \texttt{/group/connexions}
	\item \texttt{/group/nomDuParamère/fonctionnalité}
\end{itemize}
