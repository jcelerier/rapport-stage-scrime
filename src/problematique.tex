...
\begin{table}[H]
	...
	\begin{tabu} to \linewidth {r |@{\vtbullet} X[l]}
		...
		Début à mi-mars & Conception de l'application de test de répartition, portage sous \brand{Android} et plateformes \brand{ARM} \\
		...
		Début à mi-avril & Formalisation et vérification, portage de \brand{Jamoma} sous CMake \\
